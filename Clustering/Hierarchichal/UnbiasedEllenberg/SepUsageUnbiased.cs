...
{
    public class SepUsageUnbiased : ClusteringAlgorithm
    {
        ...
        private double Similarity(FeatureVectorContainer left, FeatureVectorContainer right)
            => UnbiasedEllenberg(left.DependencyFeatureVectors, right.DependencyFeatureVectors)
               + UnbiasedEllenberg(left.UsageFeatureVectors, right.UsageFeatureVectors);
